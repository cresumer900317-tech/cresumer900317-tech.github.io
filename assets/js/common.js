...
document.addEventListener("DOMContentLoaded", () => {
  const css = document.createElement("link"); css.rel="stylesheet"; css.href="./assets/css/lounge-upgrade.css?v=4"; if(!document.querySelector('link[href*="lounge-upgrade.css"]')) document.head.append(css);
